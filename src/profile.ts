...
export const assistantProfile = {
  ...
  description:
    'Priya Gautam is a Full Stack Developer with hands-on experience building scalable web applications using React.js, Next.js, Node.js, Express.js, FastAPI, and MongoDB. She has experience in AI engineering, REST API integration, real-time applications, web scraping, and startup environments.',
  education: [
    {
